...
//    }
    ...
    NSDate* localDateTime = [NSDate dateWithTimeInterval:[[NSTimeZone systemTimeZone] secondsFromGMT] sinceDate:dateStartTime];
    
    NSString *startTimeString = [startTimeFormatter1 stringFromDate:localDateTime];
