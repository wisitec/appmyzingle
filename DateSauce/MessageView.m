...
-(void)onPageLoad
{
        fontname13 = [UIFont fontWithName:@"GothamRounded-Bold" size:13];
        fontname14 = [UIFont fontWithName:@"GothamRounded-Medium" size:14];
        fontname15 = [UIFont fontWithName:@"GothamRounded-Book" size:15];
        fontname15_16 = [UIFont fontWithName:@"GothamRounded-Bold" size:14];
        fontname17 = [UIFont fontWithName:@"GothamRounded-Medium" size:17];
        fontname18 = [UIFont fontWithName:@"GothamRounded-Medium" size:18];
        ...
        lblNewMatches.textColor= [UIColor colorWithRed:235/255.0 green:68/255.0 blue:97/255.0 alpha:1.0];
        ...
        lblMessages.textColor=[UIColor colorWithRed:235/255.0 green:68/255.0 blue:97/255.0 alpha:1.0];
