...
- (UIView *)nextViewForSwipeableView:(ZLSwipeableView *)swipeableView {
    ...
    CardView *view = [[CardView alloc] initWithFrame:CGRectMake(20, 10, self.view.frame.size.width-40, 300)];
    view.backgroundColor = [self colorForName:self.colors[self.colorIndex]];
    self.colorIndex++;

    
    UILabel *lblInfo=[[UILabel alloc]initWithFrame:CGRectMake(20, 20, 80, 30)];
    lblInfo.text=@"Gopal";
