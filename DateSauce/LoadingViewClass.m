...
//    loadingView = [[UIView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width)/2 - 90, ([UIScreen mainScreen].bounds.size.height)/2 - 50, 180, 100)];
    ...
    loadingView = [[UIView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width)/2 - 45, ([UIScreen mainScreen].bounds.size.height)/2 - 25, 90, 50)];
...
//    UIView *loadView = [[UIView alloc]initWithFrame:CGRectMake((loadingView.bounds.size.width) - 50,(loadingView.bounds.size.height)/2 - 50, 200, 100)];
//    loadView.backgroundColor = [UIColor whiteColor];
//    [loadingView addSubview: loadView];

    UIImageView *animatedImageView = [[UIImageView alloc] init];
    [animatedImageView setFrame:CGRectMake((loadingView.bounds.size.width)/2 - 25,(loadingView.bounds.size.height)/2 - 25, 50, 50)];
    ...
    //[loadView addSubview:loadingView];
...
//    [loadingView addSubview: loadView];
    ...
    UIImageView *animatedImageView = [[UIImageView alloc] init];
    [animatedImageView setFrame:CGRectMake((loadingView.bounds.size.width)/2 - 20,(loadingView.bounds.size.height)/2 - 20, 40, 40)];
    animatedImageView.image = [UIImage animatedImageWithAnimatedGIFData:[NSData dataWithContentsOfURL:url]];
    animatedImageView.image = [UIImage animatedImageWithAnimatedGIFURL:url];
    [loadingView addSubview: animatedImageView];
